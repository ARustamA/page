...
import { linkedin, urlTelegram, whatsappUrl } from '../../assets/constants/constants';
...
const titleStyle = 'flex flex-col gap-1 items-center justify-center hover:text-main_red cursor-none';
const linkStyle =
      ...
      <div className="flex flex-col gap-3 lg:flex-row max-w-5xl mx-auto">
        ...
        <div className="flex flex-col gap-3 lg:pt-16">
          ...
          <div className={cardStyle}>
            ...
            <a href={linkedin} target="_blank" className={linkStyle}>
              <button type="button" className="hover:text-main_red">
                rustam-akhmetyanov
              </button>
            </a>
